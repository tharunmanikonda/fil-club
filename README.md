...
The listed Expo SDK 54 with Expo Router v4. While setting up the mobile app, I ran into compatibility issues with that exact combination in local install and runtime.
